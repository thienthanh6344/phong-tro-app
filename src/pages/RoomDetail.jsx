...
export default function RoomDetail() {
  ...
  const handleCall = () => { window.location.href = "tel:" + room.phone; };
  const handleEmail = () => { window.location.href = "mailto:" + room.userEmail; };
  ...
  if (!room) return (
    <div className="min-h-screen bg-gray-100">
      <Navbar />
      <p className="text-center mt-20 text-gray-500">Không tìm thấy phòng trọ!</p>
    </div>
  );
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <img
            src={room.imageUrl || "https://placehold.co/800x400?text=Phong+tro"}
            alt={room.title}
          ...
          <div className="p-6">
            <div className="flex justify-between items-start mb-4">
              <h1 className="text-2xl font-bold text-gray-800 flex-1">{room.title}</h1>
            ...
            <div className="grid grid-cols-2 gap-4 bg-gray-50 rounded-xl p-4 mb-6">
              ...
              <div>
                ...
                <p className="font-medium">👤 {room.userEmail}</p>
              </div>
            </div>

            {room.description && (
              <div className="mb-6">
                <h2 className="text-lg font-bold mb-2 text-gray-700">Mô tả chi tiết</h2>
            ...
            {room.lat && room.lng && (
              <div className="mb-6">
                <h2 className="text-lg font-bold mb-3 text-gray-700">📍 Vị trí trên bản đồ</h2>
                <MapContainer
            ...
            <div className="bg-blue-50 rounded-xl p-5 border border-blue-100">
              <h2 className="text-lg font-bold mb-3 text-blue-700">📞 Thông tin liên hệ</h2>
              <p className="text-gray-700 mb-1">
                <span className="font-medium">Số điện thoại: </span>{room.phone}
              </p>
              <p className="text-gray-700 mb-4">
                <span className="font-medium">Email: </span>{room.userEmail}
              </p>
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => navigate(`/chat/${room.id}/${room.userId}`)}
